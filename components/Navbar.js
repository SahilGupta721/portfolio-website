  ...
  return (
    <header className="sticky top-0 z-50 bg-transparent">
      <div className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40">
        <div className="mx-auto my-2 flex w-full max-w-[1280px] items-center justify-between gap-4 whitespace-nowrap rounded-full border border-gray-200 bg-white/90 px-4 py-[0.85rem] shadow-sm backdrop-blur-[12px]">
          <Link className="flex items-center gap-3 no-underline" href="/">
            ...
            <span className="text-[1.1rem] font-bold leading-none tracking-[-0.02em] text-gray-900">
              Sahil Gupta
            </span>
          </Link>
