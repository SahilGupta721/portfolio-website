    ...
    <section className={styles.servicesSection} id="services">
      <div className={styles.container}>
        <div className={styles.textCenter}>
          <p className={styles.servicesBadge}>My Services</p>
          <h2 className={styles.servicesTitle}>Innovating Through Code</h2>
        ...
        <div className={styles.servicesGrid}>
          ...
          <div className={styles.serviceCard}>
            <dt className={styles.serviceHeading}>
              <div className={`${styles.iconCircle} ${styles.ocean}`}>
            ...
            <dd className={styles.serviceText}>
              <ul>
                ...
                <li>C#</li><li>TypeScript</li><li>HTML5</li><li>CSS3</li>
              </ul>
            </dd>
          </div>
          ...
          <div className={styles.serviceCard}>
            ...
            <dd className={styles.serviceText}>
              <ul>
                <li>React.js</li><li>Node.js</li><li>Express.js</li>
                <li>FastAPI</li><li>Tailwind CSS</li>
              </ul>
            </dd>
          </div>
          ...
          <div className={styles.serviceCard}>
            ...
            <dd className={styles.serviceText}>
              <ul>
                <li>Scikit-Learn</li><li>TensorFlow / PyTorch</li>
                <li>OpenAI API</li><li>Large Language Models (Cohere, Gemini, ChatGPT)</li>
          ...
          <div className={styles.serviceCard}>
            <dt className={styles.serviceHeading}>
              <div className={`${styles.iconCircle} ${styles.olive}`}>
                <svg className={styles.icon} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
            ...
            <dd className={styles.serviceText}>
              <ul>
                <li>Google Cloud</li><li>Azure</li><li>MongoDB</li>
          ...
          <div className={styles.serviceCard}>
            <dt className={styles.serviceHeading}>
              <div className={`${styles.iconCircle} ${styles.terracotta}`}>
                <svg className={styles.icon} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
            ...
            <dd className={styles.serviceText}>
              <ul>
                <li>Pandas</li><li>NumPy</li><li>Matplotlib</li>
                <li>SQL (Analytics & Queries)</li><li>Power BI</li><li>Microsoft Excel</li>
              </ul>
            </dd>
          </div>
          ...
          <div className={styles.serviceCard}>
            ...
            <dd className={styles.serviceText}>
              <ul>
                <li>Git</li><li>Docker</li><li>Postman</li>
                <li>Jira/Trello</li><li>MS Office 365</li><li>Visual Studio Code</li>
              </ul>
            </dd>
          </div>
        </div>
